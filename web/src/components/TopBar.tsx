...
export function TopBar() {
  ...
  // The way we solve this is: dark navy header with the brand mark on the left and a
  // minimal icon strip on the right (help / settings / account), mirroring the Podium
  // app shell pattern.
  // flow: App mounts -> TopBar <-- HERE (above main two-pane layout)
  return (
